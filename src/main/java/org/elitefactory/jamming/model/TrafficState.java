...
public class TrafficState {
	...
	private Date time;
	private RocadeDirection direction;
	...
	public TrafficState(Date time, RocadeDirection direction) {
		super();
		this.time = time;
	...
	public RocadeDirection getDirection() {
		return direction;
	}

	public void setDirection(RocadeDirection direction) {
